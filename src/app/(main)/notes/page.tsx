...
const NotesList = dynamic(() => import("./_components/notes-list").then(mod => mod.NotesList));
...
export default function NotesPage() {
  ...
  const handlePasscodeConfirm = useCallback((enteredPasscode: string) => {
    if (passcode) {
  ...
  return (
    ...
    >
      ...
      <input
        ...
        accept=".json"
      />
      {isPasscodeDialogOpen && <PasscodeDialog
