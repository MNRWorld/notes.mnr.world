...
const WritingHeatmap = dynamic(
  () => import("./_components/writing-heatmap"),
  { ssr: false },
);
...
function DashboardContent() {
  ...
  const dashboardData = useMemo(() => {
    ...
    return {
      ...
      wordCountChartData,
      longestStreak,
      totalNotes: debouncedNotes.length,
      totalWords,
    };
  }, [debouncedNotes]);
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // This ensures components depending on client-side info render only on the client
    setIsClient(true);
  }, []);
