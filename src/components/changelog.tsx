    ...
    changes: [
      {
        ...
        title: "অঙ্কন টুল",
        description:
          "ক্যানভাস-ভিত্তিক অঙ্কন টুল যোগ করা হয়েছে। এখন আপনি নোটে ছবি এবং ডায়াগ্রাম আঁকতে পারবেন।",
        icon: "Feather",
      },
      {
        type: "feature",
        ...
        description:
          "LaTeX/KaTeX সাপোর্ট যোগ করা হয়েছে। একাডেমিক নোটের জন্য গণিতের সূত্র লিখতে পারবেন।",
        icon: "Plus",
      },
      {
        type: "feature",
        ...
        description:
          "মার্কডাউন ফরম্যাটে নোট এক্সপোর্ট এবং ইম্পোর্ট করার সুবিধা।",
        icon: "FileText",
      },
      {
        type: "feature",
      ...
      },
      {
        ...
        description:
          "Git-এর মতো ভার্সন হিস্ট্রি এবং ব্র্যাঞ্চিং সিস্টেম যোগ করা হয়েছে।",
        icon: "History",
      },
      {
        type: "feature",
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full ${getTypeColor(entry.type)}`}
                    />
