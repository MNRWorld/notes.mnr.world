  ...
  const steps = [
    ...
    <StepContent key="welcome">
      ...
      >
        <h2 className="mb-4 text-2xl md:text-3xl font-bold bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">
          MNR নোট 3.0-এ স্বাগতম!
        </h2>
        <p className="mb-6 max-w-md text-base md:text-lg text-muted-foreground leading-relaxed">
          আপনার স্মার্ট নোট-টেকিং সঙ্গী এখন আরও শক্তিশালী! ৯টি দুর্দান্ত নতুন ফিচার দিয়ে সাজানো এই নতুন সংস্করণ।
        </p>
    ...
    <StepContent key="enhanced-features">
      ...
      >
        ...
        <p className="mb-6 max-w-md text-sm md:text-base text-muted-foreground leading-relaxed">
          MNR নোট 3.0 এ যুক্ত হয়েছে ৯টি চমৎকার নতুন ফিচার। আপনার প্রতিদিনের কাজকে আরও সহজ করে তুলতে প্রতিটি ফিচার যত্ন সহকারে ডিজাইন করা হয়েছে।
        </p>
      </motion.div>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full max-w-xl mx-auto justify-items-center items-center">
        {[
          {
            icon: Icons.Pencil,
            title: "ড্রয়িং টুলস",
    ...
    <StepContent key="profile">
      ...
      >
        ...
        <p className="mb-6 max-w-sm text-sm md:text-base text-muted-foreground">
          একটি প্রোফাইল ছবি আপলোড করুন এবং আপনার পছন্দের নাম দিন - এটি আপনার অভিজ্ঞতাকে আরো ব্যক্তিগত করে তুলবে।
        </p>
      </motion.div>
      <motion.div
    ...
    <StepContent key="ai">
      ...
      >
        ...
        <h2 className="mb-3 text-xl md:text-2xl font-bold">
          mnrAI - আপনার বুদ্ধিমান সহায়ক
        </h2>
        <p className="mb-6 max-w-md text-sm md:text-base text-muted-foreground leading-relaxed">
          Google Gemini AI এর অত্যাধুনিক প্রযুক্তি দিয়ে তাৎক্ষণিক প্রশ্নের উত্তর পান, নতুন আইডিয়া আবিষ্কার করুন এবং আপনার লেখার গুণমান বাড়ান।
        </p>
      </motion.div>
    ...
    <StepContent key="templates">
      ...
      >
        ...
        <h2 className="mb-3 text-xl md:text-2xl font-bold">
          স্মার্ট টেমপ্লেট সংগ্রহ
        </h2>
        <p className="mb-6 max-w-md text-sm md:text-base text-muted-foreground leading-relaxed">
          আগে থেকে প্রস্তুত করা টেমপ্লেট দিয়ে দ্রুত এবং সহজে লেখা শুরু করুন। মিটিং নোট থেকে প্রজেক্ট পরিকল্পনা - সব ধরনের কাজের জন্য রয়েছে আলাদা টেমপ্লেট।
        </p>
      </motion.div>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 w-full max-w-lg mx-auto justify-items-center items-center">
        {[
    ...
    <StepContent key="security">
      ...
      >
        ...
        <p className="mb-6 max-w-md text-sm md:text-base text-muted-foreground leading-relaxed">
          আপনার সকল তথ্য নিরাপদে আপনার ডিভাইসে সংরক্ষিত থাকবে। বাড়তি নিরাপত্তার জন্য পাসকোড দিয়ে গুরুত্বপূর্ণ নোটগুলো সুরক্ষিত করুন।
        </p>
      </motion.div>
    ...
    <StepContent key="start">
      ...
      >
        ...
        <p className="mb-6 max-w-md text-base md:text-lg text-muted-foreground leading-relaxed">
          {localName ? `${localName}, ` : ""}আপনি এখন MNR নোট 3.0 এর সমস্ত আধুনিক ফিচার ব্যবহার করার জন্য সম্পূর্ণ প্রস্তুত! ড্রয়িং টুলস, প্রাইভেসি মোড - সবকিছুই এখন আপনার নিয়ন্ত্রণে।
        </p>
        <div className="flex gap-2 justify-center flex-wrap">
      ...
      >
        নতুন ফিচারগুলো দেখতে হোমপেজে "ডেমো নোট" বাটনে ক্লিক করুন। আপনি চাইলে এই সব ফিচার প্রোফাইল সেটিংস থেকে পরে কাস্টমাইজ করতে পারবেন।
      </div>
      </motion.div>
    </StepContent>,
  ];
