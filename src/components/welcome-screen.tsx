  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      <motion.div
        ...
        className="absolute bottom-32 left-1/4 text-primary/30"
      >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                size="lg"
                className="bg-primary hover:bg-primary/80 text-primary-foreground font-semibold px-8 py-4 rounded-xl shadow-lg hover-lift group"
              >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-primary/30 glass-card hover:bg-primary/10 hover:border-primary/50 px-8 py-4 rounded-xl font-semibold group hover-lift"
              >
