...
export default function Header() {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 z-20 flex h-16 w-full items-center justify-center border-b border-border/50 bg-background/95 backdrop-blur-xl supports-[backdrop-filter]:bg-background/80 px-4 sm:px-6 lg:hidden shadow-sm",
        isEditorPage && "hidden",
      )}
    >
