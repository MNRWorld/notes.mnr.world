...
export const welcomeNote: Note = {
  id: "note_welcome",
  title: "🚀 MNR নোট 3.0 - স্মার্ট নোট-টেকিং এর নতুন যুগ",
  content: {
    time: now,
    version: "3.0.0",
    blocks: [
      {
        ...
        type: "paragraph",
        data: {
          text: "🎉 MNR নোট এর সবচেয়ে শক্তিশালী আপডেটে স্বাগতম! এই সংস্করণে রয়েছে ৯টি বিপ্লবী নতুন ফিচার যা আপনার নোট-টেকিং অভিজ্ঞতাকে সম্পূর্ণ নতুন মাত্রায় নিয়ে যাবে।",
        },
      },
      {
      ...
      },
      {
        ...
        type: "quote",
        data: {
          text: "MNR নোট 3.0 দিয়ে আপনার সৃজনশীলতাকে নতুন উচ্চতায় নিয়ে যান। প্রতিটি ফিচার বাংলা ভাষাভাষী ব্যবহারকারীদের কথা মাথায় রেখে ডিজাইন করা হয়েছে।",
          caption: "উন্নয়ন টিম",
          alignment: "left",
        },
      },
        ...
        blocks: [
          {
            ...
            type: "paragraph",
            data: { text: "MNR নোট-এ স্বাগতম ✨ - পুরানো সংস্করণ" },
          },
        ],
      },
